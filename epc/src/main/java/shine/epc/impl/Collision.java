...
public class Collision {
	...
	public static Collision TOP_COLLISION = new Collision("*");
	 ...
	 * @return 一个冲突体实例
	 */
	public static Collision generateCollision(String customerId) {
		return (customerId == null)? null : new Collision(customerId);
	}
	 ...
	 * @return 顶级冲突体
	 */
	public static Collision gainTopCollision(){
